...
const FermSvg = (props) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62.23 83.48" fill={fill} stroke={stroke} strokeMiterlimit={10} style={{height: "60%", maxHeight: "250px"}}>
            ...
            <g id="fermSvgDiagram">
                ...
                <image href={impeller} x="25%" y="2%" height="110%" width="50%"/>
            </g>
        </svg>
    )
}
